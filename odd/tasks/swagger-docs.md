...
Work unit 1 merged (#91). Work unit 2: S0 (#93) and S1 (#94) merged; S2 merged (#95); S3 merged (#96); S4 merged (#97); S5 merged (#98); work unit 2 complete except its follow-ups. Work unit 3: 3.1 merged (#99); 3.2 done on `docs/knowledge-base-02-domain`, PR pending; next 3.3 operations. After it merges, work unit 2 is complete except its follow-ups; next is work unit 3 (`docs/` pages).
